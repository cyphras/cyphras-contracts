...
// Poseidon the circuit uses. The on-chain verifier and pool must feed these exact
...
writeFileSync(
  ...
  JSON.stringify(
    {
      note: "circomlib Poseidon over BN254. The on-chain Poseidon must reproduce these with the Stellar host function and assert equality before any deployment.",
      curve: "bn254",
      vectors,
    },
    null,
